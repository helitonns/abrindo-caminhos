...
public class AutorizacaoDAO{
    ...
    public Autorizacao verificarSeOUsuarioPossuiAutorizacao(String chave, String login, String senha) throws DAOException{
        try {
            return (Autorizacao) em.createQuery("select o from Autorizacao o where o.privilegio.sistema.chave =:chaveSistema and o.usuario.login =:loginUsuario and o.usuario.senha =:senhaUsuario and o.usuario.status = true and o.status = true")
                    .setParameter("chaveSistema", chave)
